...
Last reviewed: 2026-09-21 against `e8810f7` (master green, two consecutive runs) plus the uncommitted T-121 change set. **The corridor renders.** M2 is two of five done; T-122 next.
...
| T-121 | Client track scene: chunk instancing, sleeper `MultiMesh`, LOD | `done` (2026-09-21, uncommitted) — F18 open | T-115, T-120 | [task_121](docs/tasks/task_121_client_track_scene.md) |
